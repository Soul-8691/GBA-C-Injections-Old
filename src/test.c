...
const u8 gCardGraphics[] = INCBIN_U8(
	...
	"graphics/Resize/AlbaLenatustheAbyssDragon.6bpp",
	"graphics/Resize/AlbiontheBrandedDragon.6bpp",
	"graphics/Resize/AlbiontheSanctifireDragon.6bpp",
	"graphics/Resize/AleistertheInvoker.6bpp",
	"graphics/Resize/AlienShocktrooper.6bpp",
	"graphics/Resize/AllyofJusticeClausolas.6bpp",
	"graphics/Resize/AmorphactorPaintheImaginationDracoverlord.6bpp",
	"graphics/Resize/AmorphousPersona.6bpp",
	"graphics/Resize/AmphibianBeast.6bpp",
	"graphics/Resize/AmuletDragon.6bpp",
	"graphics/Resize/ArchfiendSoldier.6bpp",
	"graphics/Resize/ArchfiendsAwakening.6bpp",
	"graphics/Resize/ArchfiendsManifestation.6bpp",
	...
	"graphics/Resize/BlazingCartesiatheVirtuous.6bpp",
	"graphics/Resize/BlazingInpachi.6bpp",
	"graphics/Resize/BlowbackDragon.6bpp",
	"graphics/Resize/BlueEyesChaosDragon.6bpp",
	"graphics/Resize/BlueEyesTwinBurstDragon.6bpp",
	"graphics/Resize/BlueEyesTyrantDragon.6bpp",
	"graphics/Resize/BorreloadRiotDragon.6bpp",
	"graphics/Resize/BrigrandtheGloryDragon.6bpp",
	"graphics/Resize/Bunilla.6bpp",
	"graphics/Resize/BusterBladertheDragonDestroyerSwordsman.6bpp",
	"graphics/Resize/CeruleanSacredPhoenixofNephthys.6bpp",
	"graphics/Resize/ChamberlainoftheSixSamurai.6bpp",
	"graphics/Resize/ChaosForm.6bpp",
	"graphics/Resize/CharcoalInpachi.6bpp",
	"graphics/Resize/ClavkiystheMagikeySkyblaster.6bpp",
	"graphics/Resize/ConductorofNephthys.6bpp",
	"graphics/Resize/ContractwiththeAbyss.6bpp",
	"graphics/Resize/CrownedbytheWorldChalice.6bpp",
	"graphics/Resize/CurseoftheMaskedBeast.6bpp",
	"graphics/Resize/CyberDragon.6bpp",
	"graphics/Resize/CyberOgre.6bpp",
	"graphics/Resize/CyberOgre2.6bpp",
	"graphics/Resize/CyberTwinDragon.6bpp",
	"graphics/Resize/DDTrainer.6bpp",
	"graphics/Resize/DarkBlade.6bpp",
	"graphics/Resize/DarkCavalry.6bpp",
	"graphics/Resize/DarkMagicianGirltheDragonKnight.6bpp",
	"graphics/Resize/DarkMagiciantheDragonKnight.6bpp",
	"graphics/Resize/DarkMagiciantheKnightofDragonMagic.6bpp",
	"graphics/Resize/DarkPaladin.6bpp",
	"graphics/Resize/DarklordMarie.6bpp",
	"graphics/Resize/DawnoftheHerald.6bpp",
	"graphics/Resize/DivineDragonRagnarok.6bpp",
	"graphics/Resize/DivineGraceNorthwemko.6bpp",
	"graphics/Resize/Dogmatikamacabre.6bpp",
	"graphics/Resize/EarthboundSpirit.6bpp",
	"graphics/Resize/ElementalHEROClayman.6bpp",
	"graphics/Resize/EmpressMantis.6bpp",
	"graphics/Resize/EvigishkiMindAugus.6bpp",
	"graphics/Resize/EvigishkiSoulOgre.6bpp",
	"graphics/Resize/EvigishkiTetrogre.6bpp",
	"graphics/Resize/EvilswarmHeliotrope.6bpp",
	"graphics/Resize/FallenofAlbaz.6bpp",
	"graphics/Resize/Frostosaurus.6bpp",
	"graphics/Resize/Gagagigo.6bpp",
	"graphics/Resize/GatlingDragon.6bpp",
	"graphics/Resize/GearfriedtheRedEyesIronKnight.6bpp",
	"graphics/Resize/GemKnightGarnet.6bpp",
	"graphics/Resize/GemKnightGarnet.6bpp",
	"graphics/Resize/GemKnightRuby.6bpp",
	...
	"graphics/Resize/GishkiNekromirror.6bpp",
	"graphics/Resize/GishkiNekromirror.6bpp",
	"graphics/Resize/GishkiNekromirror.6bpp",
	"graphics/Resize/GladiatorBeastAndal.6bpp",
	"graphics/Resize/GoodEvilintheBurningAbyss.6bpp",
	"graphics/Resize/GranguignoltheDuskDragon.6bpp",
	"graphics/Resize/GraphaDragonLordofDarkWorld.6bpp",
	"graphics/Resize/GraphaDragonOverlordofDarkWorld.6bpp",
	"graphics/Resize/GreatAngus.6bpp",
	"graphics/Resize/HeavyInterlock.6bpp",
	"graphics/Resize/HeraldofPerfection.6bpp",
	"graphics/Resize/HumanoidSlime.6bpp",
	"graphics/Resize/HunterDragon.6bpp",
	"graphics/Resize/HymnofLight.6bpp",
	"graphics/Resize/Inpachi.6bpp",
	"graphics/Resize/InsectKnight.6bpp",
	"graphics/Resize/InvokedAugoeides.6bpp",
	"graphics/Resize/InvokedPurgatrio.6bpp",
	"graphics/Resize/IslandTurtle.6bpp",
	"graphics/Resize/JerryBeansMan.6bpp",
	"graphics/Resize/Kabazauls.6bpp",
	"graphics/Resize/KingDragun.6bpp",
	"graphics/Resize/LegendaryDuelingField.6bpp",
	"graphics/Resize/LibromancerBonded.6bpp",
	"graphics/Resize/LibromancerBonded.6bpp",
	"graphics/Resize/LibromancerDoombroker.6bpp",
	"graphics/Resize/LibromancerFireburst.6bpp",
	"graphics/Resize/LightBringerLucifer.6bpp",
	"graphics/Resize/LubelliontheSearingDragon.6bpp",
	...
	"graphics/Resize/MagikeyMaftea.6bpp",
	"graphics/Resize/MagikeyMaftea.6bpp",
	"graphics/Resize/MagikeyMechmortarGaresglasser.6bpp",
	"graphics/Resize/MagikeyMechmusketBatosbuster.6bpp",
	"graphics/Resize/MalacodaNetherlordoftheBurningAbyss.6bpp",
	"graphics/Resize/MasterKyonshee.6bpp",
	"graphics/Resize/MasterofChaos.6bpp",
	"graphics/Resize/MegalithAratron.6bpp",
	"graphics/Resize/MegalithHagith.6bpp",
	"graphics/Resize/MegalithOch.6bpp",
	"graphics/Resize/MegalithOphiel.6bpp",
	"graphics/Resize/MegalithPhul.6bpp",
	"graphics/Resize/MegalithUnformed.6bpp",
	"graphics/Resize/MegalithUnformed.6bpp",
	"graphics/Resize/MegalithUnformed.6bpp",
	"graphics/Resize/MegalithUnformed.6bpp",
	"graphics/Resize/MegalithUnformed.6bpp",
	"graphics/Resize/MelffyRabby.6bpp",
	"graphics/Resize/MirrorjadetheIcebladeDragon.6bpp",
	"graphics/Resize/NekrozKaleidoscope.6bpp",
	"graphics/Resize/NekrozKaleidoscope.6bpp",
	"graphics/Resize/NekrozKaleidoscope.6bpp",
	"graphics/Resize/NekrozofClausolas.6bpp",
	"graphics/Resize/NekrozofUnicore.6bpp",
	"graphics/Resize/NekrozofValkyrus.6bpp",
	...
	"graphics/Resize/OddEyesAdvent.6bpp",
	"graphics/Resize/OddEyesGravityDragon.6bpp",
	"graphics/Resize/OppressedPeople.6bpp",
	"graphics/Resize/Opticlops.6bpp",
	"graphics/Resize/PrimalCry.6bpp",
	"graphics/Resize/PSYFrameDriver.6bpp",
	"graphics/Resize/RebirthofNephthys.6bpp",
	"graphics/Resize/RebirthofNephthys.6bpp",
	"graphics/Resize/RedEyesDarkDragoon.6bpp",
	"graphics/Resize/RedEyesSlashDragon.6bpp",
	"graphics/Resize/RengeGatekeeperofDarkWorld.6bpp",
	"graphics/Resize/RevendreadExecutor.6bpp",
	"graphics/Resize/RevendreadOrigin.6bpp",
	"graphics/Resize/RevendreadOrigin.6bpp",
	"graphics/Resize/RevendreadOrigin.6bpp",
	"graphics/Resize/RevendreadOrigin.6bpp",
	"graphics/Resize/RindbrummtheStrikingDragon.6bpp",
	"graphics/Resize/RiseoftheSalamangreat.6bpp",
	"graphics/Resize/RitualofGrace.6bpp",
	"graphics/Resize/Sabersaurus.6bpp",
	"graphics/Resize/SaffiraQueenofDragons.6bpp",
	"graphics/Resize/SalamangreatEmeraldEagle.6bpp",
	"graphics/Resize/SauravistheAncientandAscended.6bpp",
	"graphics/Resize/SeaSerpentWarriorofDarkness.6bpp",
	"graphics/Resize/ShinatoKingofaHigherPlane.6bpp",
	"graphics/Resize/ShinatosArk.6bpp",
	"graphics/Resize/ShinobaronPeacock.6bpp",
	"graphics/Resize/ShinobaronessPeacock.6bpp",
	"graphics/Resize/ShinobirdsCalling.6bpp",
	"graphics/Resize/ShinobirdsCalling.6bpp",
	"graphics/Resize/SkullDogMarron.6bpp",
	"graphics/Resize/SonicDuck.6bpp",
	"graphics/Resize/SonicTracker.6bpp",
	"graphics/Resize/SoulTiger.6bpp",
	"graphics/Resize/SpaceMambo.6bpp",
	"graphics/Resize/SprindtheIrondashDragon.6bpp",
	"graphics/Resize/SpritesBlessing.6bpp",
	"graphics/Resize/StJoan.6bpp",
	"graphics/Resize/TerrorkingSalmon.6bpp",
	"graphics/Resize/TheDarkMagicians.6bpp",
	"graphics/Resize/TheDragonDwellingintheCave.6bpp",
	"graphics/Resize/TheForgivingMaiden.6bpp",
	"graphics/Resize/TheKingofD.6bpp",
	"graphics/Resize/TheMaskedBeast.6bpp",
	"graphics/Resize/TitanikladtheAshDragon.6bpp",
	"graphics/Resize/TrancetheMagicSwordsman.6bpp",
	"graphics/Resize/TransonicBird.6bpp",
	"graphics/Resize/VendreadBattlelord.6bpp",
	"graphics/Resize/VendreadChimera.6bpp",
	"graphics/Resize/VendreadScavenger.6bpp",
	"graphics/Resize/VennuBrightBirdofDivinity.6bpp",
	"graphics/Resize/VenomCobra.6bpp",
	"graphics/Resize/WarriorDaiGrepher.6bpp",
	"graphics/Resize/Wattaildragon.6bpp",
	"graphics/Resize/WhiteRelicofDogmatika.6bpp",
	"graphics/Resize/WolfAxwielder.6bpp",
	"graphics/Resize/XHeadCannon.6bpp",
	"graphics/Resize/XSaberAnuPiranha.6bpp",
	"graphics/Resize/XZTankCannon.6bpp",
	"graphics/Resize/ZMetalTank.6bpp",
...
const u8 gCardPalettes[] = INCBIN_U8(
	...
	"graphics/Resize/AlbaLenatustheAbyssDragon.gbapal",
	"graphics/Resize/AlbiontheBrandedDragon.gbapal",
	"graphics/Resize/AlbiontheSanctifireDragon.gbapal",
	"graphics/Resize/AleistertheInvoker.gbapal",
	"graphics/Resize/AlienShocktrooper.gbapal",
	"graphics/Resize/AllyofJusticeClausolas.gbapal",
	"graphics/Resize/AmorphactorPaintheImaginationDracoverlord.gbapal",
	"graphics/Resize/AmorphousPersona.gbapal",
	"graphics/Resize/AmphibianBeast.gbapal",
	"graphics/Resize/AmuletDragon.gbapal",
	"graphics/Resize/ArchfiendSoldier.gbapal",
	"graphics/Resize/ArchfiendsAwakening.gbapal",
	"graphics/Resize/ArchfiendsManifestation.gbapal",
	...
	"graphics/Resize/BlazingCartesiatheVirtuous.gbapal",
	"graphics/Resize/BlazingInpachi.gbapal",
	"graphics/Resize/BlowbackDragon.gbapal",
	"graphics/Resize/BlueEyesChaosDragon.gbapal",
	"graphics/Resize/BlueEyesTwinBurstDragon.gbapal",
	"graphics/Resize/BlueEyesTyrantDragon.gbapal",
	"graphics/Resize/BorreloadRiotDragon.gbapal",
	"graphics/Resize/BrigrandtheGloryDragon.gbapal",
	"graphics/Resize/Bunilla.gbapal",
	"graphics/Resize/BusterBladertheDragonDestroyerSwordsman.gbapal",
	"graphics/Resize/CeruleanSacredPhoenixofNephthys.gbapal",
	"graphics/Resize/ChamberlainoftheSixSamurai.gbapal",
	"graphics/Resize/ChaosForm.gbapal",
	"graphics/Resize/CharcoalInpachi.gbapal",
	"graphics/Resize/ClavkiystheMagikeySkyblaster.gbapal",
	"graphics/Resize/ConductorofNephthys.gbapal",
	"graphics/Resize/ContractwiththeAbyss.gbapal",
	"graphics/Resize/CrownedbytheWorldChalice.gbapal",
	"graphics/Resize/CurseoftheMaskedBeast.gbapal",
	"graphics/Resize/CyberDragon.gbapal",
	"graphics/Resize/CyberOgre.gbapal",
	"graphics/Resize/CyberOgre2.gbapal",
	"graphics/Resize/CyberTwinDragon.gbapal",
	"graphics/Resize/DDTrainer.gbapal",
	"graphics/Resize/DarkBlade.gbapal",
	"graphics/Resize/DarkCavalry.gbapal",
	"graphics/Resize/DarkMagicianGirltheDragonKnight.gbapal",
	"graphics/Resize/DarkMagiciantheDragonKnight.gbapal",
	"graphics/Resize/DarkMagiciantheKnightofDragonMagic.gbapal",
	"graphics/Resize/DarkPaladin.gbapal",
	"graphics/Resize/DarklordMarie.gbapal",
	"graphics/Resize/DawnoftheHerald.gbapal",
	"graphics/Resize/DivineDragonRagnarok.gbapal",
	"graphics/Resize/DivineGraceNorthwemko.gbapal",
	"graphics/Resize/Dogmatikamacabre.gbapal",
	"graphics/Resize/EarthboundSpirit.gbapal",
	"graphics/Resize/ElementalHEROClayman.gbapal",
	"graphics/Resize/EmpressMantis.gbapal",
	"graphics/Resize/EvigishkiMindAugus.gbapal",
	"graphics/Resize/EvigishkiSoulOgre.gbapal",
	"graphics/Resize/EvigishkiTetrogre.gbapal",
	"graphics/Resize/EvilswarmHeliotrope.gbapal",
	"graphics/Resize/FallenofAlbaz.gbapal",
	"graphics/Resize/Frostosaurus.gbapal",
	"graphics/Resize/Gagagigo.gbapal",
	"graphics/Resize/GatlingDragon.gbapal",
	"graphics/Resize/GearfriedtheRedEyesIronKnight.gbapal",
	"graphics/Resize/GemKnightGarnet.gbapal",
	"graphics/Resize/GemKnightGarnet.gbapal",
	"graphics/Resize/GemKnightRuby.gbapal",
	...
	"graphics/Resize/GishkiNekromirror.gbapal",
	"graphics/Resize/GishkiNekromirror.gbapal",
	"graphics/Resize/GishkiNekromirror.gbapal",
	"graphics/Resize/GladiatorBeastAndal.gbapal",
	"graphics/Resize/GoodEvilintheBurningAbyss.gbapal",
	"graphics/Resize/GranguignoltheDuskDragon.gbapal",
	"graphics/Resize/GraphaDragonLordofDarkWorld.gbapal",
	"graphics/Resize/GraphaDragonOverlordofDarkWorld.gbapal",
	"graphics/Resize/GreatAngus.gbapal",
	"graphics/Resize/HeavyInterlock.gbapal",
	"graphics/Resize/HeraldofPerfection.gbapal",
	"graphics/Resize/HumanoidSlime.gbapal",
	"graphics/Resize/HunterDragon.gbapal",
	"graphics/Resize/HymnofLight.gbapal",
	"graphics/Resize/Inpachi.gbapal",
	"graphics/Resize/InsectKnight.gbapal",
	"graphics/Resize/InvokedAugoeides.gbapal",
	"graphics/Resize/InvokedPurgatrio.gbapal",
	"graphics/Resize/IslandTurtle.gbapal",
	"graphics/Resize/JerryBeansMan.gbapal",
	"graphics/Resize/Kabazauls.gbapal",
	"graphics/Resize/KingDragun.gbapal",
	"graphics/Resize/LegendaryDuelingField.gbapal",
	"graphics/Resize/LibromancerBonded.gbapal",
	"graphics/Resize/LibromancerBonded.gbapal",
	"graphics/Resize/LibromancerDoombroker.gbapal",
	"graphics/Resize/LibromancerFireburst.gbapal",
	"graphics/Resize/LightBringerLucifer.gbapal",
	"graphics/Resize/LubelliontheSearingDragon.gbapal",
	...
	"graphics/Resize/MagikeyMaftea.gbapal",
	"graphics/Resize/MagikeyMaftea.gbapal",
	"graphics/Resize/MagikeyMechmortarGaresglasser.gbapal",
	"graphics/Resize/MagikeyMechmusketBatosbuster.gbapal",
	"graphics/Resize/MalacodaNetherlordoftheBurningAbyss.gbapal",
	"graphics/Resize/MasterKyonshee.gbapal",
	"graphics/Resize/MasterofChaos.gbapal",
	"graphics/Resize/MegalithAratron.gbapal",
	"graphics/Resize/MegalithHagith.gbapal",
	"graphics/Resize/MegalithOch.gbapal",
	"graphics/Resize/MegalithOphiel.gbapal",
	"graphics/Resize/MegalithPhul.gbapal",
	"graphics/Resize/MegalithUnformed.gbapal",
	"graphics/Resize/MegalithUnformed.gbapal",
	"graphics/Resize/MegalithUnformed.gbapal",
	"graphics/Resize/MegalithUnformed.gbapal",
	"graphics/Resize/MegalithUnformed.gbapal",
	"graphics/Resize/MelffyRabby.gbapal",
	"graphics/Resize/MirrorjadetheIcebladeDragon.gbapal",
	"graphics/Resize/NekrozKaleidoscope.gbapal",
	"graphics/Resize/NekrozKaleidoscope.gbapal",
	"graphics/Resize/NekrozKaleidoscope.gbapal",
	"graphics/Resize/NekrozofClausolas.gbapal",
	"graphics/Resize/NekrozofUnicore.gbapal",
	"graphics/Resize/NekrozofValkyrus.gbapal",
	...
	"graphics/Resize/OddEyesAdvent.gbapal",
	"graphics/Resize/OddEyesGravityDragon.gbapal",
	"graphics/Resize/OppressedPeople.gbapal",
	"graphics/Resize/Opticlops.gbapal",
	"graphics/Resize/PrimalCry.gbapal",
	"graphics/Resize/PSYFrameDriver.gbapal",
	"graphics/Resize/RebirthofNephthys.gbapal",
	"graphics/Resize/RebirthofNephthys.gbapal",
	"graphics/Resize/RedEyesDarkDragoon.gbapal",
	"graphics/Resize/RedEyesSlashDragon.gbapal",
	"graphics/Resize/RengeGatekeeperofDarkWorld.gbapal",
	"graphics/Resize/RevendreadExecutor.gbapal",
	"graphics/Resize/RevendreadOrigin.gbapal",
	"graphics/Resize/RevendreadOrigin.gbapal",
	"graphics/Resize/RevendreadOrigin.gbapal",
	"graphics/Resize/RevendreadOrigin.gbapal",
	"graphics/Resize/RindbrummtheStrikingDragon.gbapal",
	"graphics/Resize/RiseoftheSalamangreat.gbapal",
	"graphics/Resize/RitualofGrace.gbapal",
	"graphics/Resize/Sabersaurus.gbapal",
	"graphics/Resize/SaffiraQueenofDragons.gbapal",
	"graphics/Resize/SalamangreatEmeraldEagle.gbapal",
	"graphics/Resize/SauravistheAncientandAscended.gbapal",
	"graphics/Resize/SeaSerpentWarriorofDarkness.gbapal",
	"graphics/Resize/ShinatoKingofaHigherPlane.gbapal",
	"graphics/Resize/ShinatosArk.gbapal",
	"graphics/Resize/ShinobaronPeacock.gbapal",
	"graphics/Resize/ShinobaronessPeacock.gbapal",
	"graphics/Resize/ShinobirdsCalling.gbapal",
	"graphics/Resize/ShinobirdsCalling.gbapal",
	"graphics/Resize/SkullDogMarron.gbapal",
	"graphics/Resize/SonicDuck.gbapal",
	"graphics/Resize/SonicTracker.gbapal",
	"graphics/Resize/SoulTiger.gbapal",
	"graphics/Resize/SpaceMambo.gbapal",
	"graphics/Resize/SprindtheIrondashDragon.gbapal",
	"graphics/Resize/SpritesBlessing.gbapal",
	"graphics/Resize/StJoan.gbapal",
	"graphics/Resize/TerrorkingSalmon.gbapal",
	"graphics/Resize/TheDarkMagicians.gbapal",
	"graphics/Resize/TheDragonDwellingintheCave.gbapal",
	"graphics/Resize/TheForgivingMaiden.gbapal",
	"graphics/Resize/TheKingofD.gbapal",
	"graphics/Resize/TheMaskedBeast.gbapal",
	"graphics/Resize/TitanikladtheAshDragon.gbapal",
	"graphics/Resize/TrancetheMagicSwordsman.gbapal",
	"graphics/Resize/TransonicBird.gbapal",
	"graphics/Resize/VendreadBattlelord.gbapal",
	"graphics/Resize/VendreadChimera.gbapal",
	"graphics/Resize/VendreadScavenger.gbapal",
	"graphics/Resize/VennuBrightBirdofDivinity.gbapal",
	"graphics/Resize/VenomCobra.gbapal",
	"graphics/Resize/WarriorDaiGrepher.gbapal",
	"graphics/Resize/Wattaildragon.gbapal",
	"graphics/Resize/WhiteRelicofDogmatika.gbapal",
	"graphics/Resize/WolfAxwielder.gbapal",
	"graphics/Resize/XHeadCannon.gbapal",
	"graphics/Resize/XSaberAnuPiranha.gbapal",
	"graphics/Resize/XZTankCannon.gbapal",
	"graphics/Resize/ZMetalTank.gbapal",
