...
const u8 gCardGraphics[] = INCBIN_U8(
	...
	"graphics/Resize/4StarredLadybugofDoom.6bpp",
	"graphics/Resize/BazootheSoulEater.6bpp",
	"graphics/Resize/CardDestruction.6bpp",
	"graphics/Resize/DarkNecrofear.6bpp",
	"graphics/Resize/DarklordMarie.6bpp",
	"graphics/Resize/EarthboundSpirit.6bpp",
	"graphics/Resize/JarofGreed.6bpp",
	"graphics/Resize/KycootheGhostDestroyer.6bpp",
	"graphics/Resize/MagePower.6bpp",
	"graphics/Resize/MagicCylinder.6bpp",
	"graphics/Resize/MagicDrain.6bpp",
	"graphics/Resize/Maryokutai.6bpp",
	"graphics/Resize/RoyalCommand.6bpp",
	"graphics/Resize/SkullLair.6bpp",
	"graphics/Resize/SolemnWishes.6bpp",
	"graphics/Resize/SoulExchange.6bpp",
	"graphics/Resize/StJoan.6bpp",
	"graphics/Resize/TheFiendMegacyber.6bpp",
	"graphics/Resize/TheForgivingMaiden.6bpp",
	"graphics/Resize/TheLastWarriorfromAnotherPlanet.6bpp",
	"graphics/Resize/ThousandEyesIdol.6bpp",
	"graphics/Resize/ThousandEyesRestrict.6bpp",
	"graphics/Resize/TorrentialTribute.6bpp",
	"graphics/Resize/UnitedWeStand.6bpp",
	"graphics/Resize/ZombyratheDark.6bpp",
	"graphics/Resize/gCardGraphicsInsectMonsterToken.6bpp",
	"graphics/Resize/gCardGraphicsInsectMonsterToken.6bpp",
	"graphics/Resize/gCardGraphicsInsectMonsterToken.6bpp",
	"graphics/Resize/gCardGraphicsInsectMonsterToken.6bpp",
...
const u8 gCardPalettes[] = INCBIN_U8(
	...
	"graphics/Resize/4StarredLadybugofDoom.gbapal",
	"graphics/Resize/BazootheSoulEater.gbapal",
	"graphics/Resize/CardDestruction.gbapal",
	"graphics/Resize/DarkNecrofear.gbapal",
	"graphics/Resize/DarklordMarie.gbapal",
	"graphics/Resize/EarthboundSpirit.gbapal",
	"graphics/Resize/JarofGreed.gbapal",
	"graphics/Resize/KycootheGhostDestroyer.gbapal",
	"graphics/Resize/MagePower.gbapal",
	"graphics/Resize/MagicCylinder.gbapal",
	"graphics/Resize/MagicDrain.gbapal",
	"graphics/Resize/Maryokutai.gbapal",
	"graphics/Resize/RoyalCommand.gbapal",
	"graphics/Resize/SkullLair.gbapal",
	"graphics/Resize/SolemnWishes.gbapal",
	"graphics/Resize/SoulExchange.gbapal",
	"graphics/Resize/StJoan.gbapal",
	"graphics/Resize/TheFiendMegacyber.gbapal",
	"graphics/Resize/TheForgivingMaiden.gbapal",
	"graphics/Resize/TheLastWarriorfromAnotherPlanet.gbapal",
	"graphics/Resize/ThousandEyesIdol.gbapal",
	"graphics/Resize/ThousandEyesRestrict.gbapal",
	"graphics/Resize/TorrentialTribute.gbapal",
	"graphics/Resize/UnitedWeStand.gbapal",
	"graphics/Resize/ZombyratheDark.gbapal",
	"graphics/Resize/gCardGraphicsInsectMonsterToken.gbapal",
	"graphics/Resize/gCardGraphicsInsectMonsterToken.gbapal",
	"graphics/Resize/gCardGraphicsInsectMonsterToken.gbapal",
	"graphics/Resize/gCardGraphicsInsectMonsterToken.gbapal",
