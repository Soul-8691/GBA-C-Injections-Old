...
const u8 gCardGraphics[] = INCBIN_U8(
	...
	"graphics/Resize/30000YearWhiteTurtle.6bpp",
	"graphics/Resize/AbsoluteKingMegaplunder.6bpp",
	"graphics/Resize/AcrobatMonkey.6bpp",
	"graphics/Resize/AlexandriteDragon.6bpp",
	"graphics/Resize/AlienShocktrooper.6bpp",
	"graphics/Resize/AllyofJusticeClausolas.6bpp",
	"graphics/Resize/AmphibianBeast.6bpp",
	"graphics/Resize/AncientSorcerer.6bpp",
	"graphics/Resize/AncientTreeofEnlightenment.6bpp",
	"graphics/Resize/AnotherverseDragon.6bpp",
	"graphics/Resize/AnotherverseGluttonia.6bpp",
	"graphics/Resize/AnotherverseSolaria.6bpp",
	"graphics/Resize/ArchfiendSoldier.6bpp",
	"graphics/Resize/AtlanteanPikeman.6bpp",
	"graphics/Resize/BaronoftheFiendSword.6bpp",
	"graphics/Resize/BattleFootballer.6bpp",
	"graphics/Resize/BeastofTalwar.6bpp",
	"graphics/Resize/BeckonedbytheWorldChalice.6bpp",
	"graphics/Resize/BigKoala.6bpp",
	"graphics/Resize/Bitron.6bpp",
	"graphics/Resize/BladeSkater.6bpp",
	"graphics/Resize/BlazingInpachi.6bpp",
	"graphics/Resize/Blocker.6bpp",
	"graphics/Resize/BoulderTortoise.6bpp",
	"graphics/Resize/BraveScizzar.6bpp",
	"graphics/Resize/Bunilla.6bpp",
	"graphics/Resize/ChamberlainoftheSixSamurai.6bpp",
	"graphics/Resize/CharcoalInpachi.6bpp",
	"graphics/Resize/ChosenbytheWorldChalice.6bpp",
	"graphics/Resize/ChuSketheMouseFighter.6bpp",
	"graphics/Resize/ClavkiystheMagikeySkyblaster.6bpp",
	"graphics/Resize/CrownedbytheWorldChalice.6bpp",
	"graphics/Resize/CyberSoldierofDarkworld.6bpp",
	"graphics/Resize/DDTrainer.6bpp",
	"graphics/Resize/DarkBlade.6bpp",
	"graphics/Resize/DarkTitanofTerror.6bpp",
	"graphics/Resize/Digitron.6bpp",
	"graphics/Resize/DivineDragonRagnarok.6bpp",
	"graphics/Resize/EarthboundSpirit.6bpp",
	"graphics/Resize/ElementalHEROBurstinatrix.6bpp",
	"graphics/Resize/ElementalHEROClayman.6bpp",
	"graphics/Resize/ElementalHERONeos.6bpp",
	"graphics/Resize/ElementalHEROSparkman.6bpp",
	"graphics/Resize/EmpressMantis.6bpp",
	"graphics/Resize/EvilswarmHeliotrope.6bpp",
	"graphics/Resize/FairyoftheFountain.6bpp",
	"graphics/Resize/FairysGift.6bpp",
	"graphics/Resize/FlyingPenguin.6bpp",
	"graphics/Resize/Frostosaurus.6bpp",
	"graphics/Resize/GadgetSoldier.6bpp",
	"graphics/Resize/Gagagigo.6bpp",
	"graphics/Resize/GemKnightCrystal.6bpp",
	"graphics/Resize/GemKnightGarnet.6bpp",
	"graphics/Resize/GemKnightLapis.6bpp",
	"graphics/Resize/GemKnightSapphire.6bpp",
	"graphics/Resize/GemKnightTourmaline.6bpp",
	"graphics/Resize/GeneWarpedWarwolf.6bpp",
	"graphics/Resize/GigaGagagigo.6bpp",
	"graphics/Resize/GilGarth.6bpp",
	"graphics/Resize/GirochinKuwagata.6bpp",
	"graphics/Resize/GladiatorBeastAndal.6bpp",
	"graphics/Resize/GogigaGagagigo.6bpp",
	"graphics/Resize/Golgoil.6bpp",
	"graphics/Resize/GorgonEgg.6bpp",
	"graphics/Resize/Gradius.6bpp",
	"graphics/Resize/GrandTikiElder.6bpp",
	"graphics/Resize/GreatAngus.6bpp",
	"graphics/Resize/GunkanSushipShari.6bpp",
	"graphics/Resize/HeadlessKnight.6bpp",
	"graphics/Resize/HieraticSealoftheSunDragonOverlord.6bpp",
	"graphics/Resize/HumanoidSlime.6bpp",
	"graphics/Resize/HunterDragon.6bpp",
	"graphics/Resize/IgnihorseDragonith.6bpp",
	"graphics/Resize/Inpachi.6bpp",
	"graphics/Resize/InsectKnight.6bpp",
	"graphics/Resize/IslandTurtle.6bpp",
	"graphics/Resize/JerryBeansMan.6bpp",
	"graphics/Resize/JobChangeMirror.6bpp",
	"graphics/Resize/JongleurGhoulIllusionist.6bpp",
	"graphics/Resize/Kabazauls.6bpp",
	"graphics/Resize/KappaAvenger.6bpp",
	"graphics/Resize/LegendaryDuelingField.6bpp",
	"graphics/Resize/Leotron.6bpp",
	"graphics/Resize/LightBringerLucifer.6bpp",
	"graphics/Resize/Lisark.6bpp",
	"graphics/Resize/LusterDragon.6bpp",
	"graphics/Resize/LusterDragon2.6bpp",
	"graphics/Resize/MadDogofDarkness.6bpp",
	"graphics/Resize/MadLobster.6bpp",
	"graphics/Resize/MasterKyonshee.6bpp",
	"graphics/Resize/MegalosmasherX.6bpp",
	"graphics/Resize/MekkKnightAvram.6bpp",
	"graphics/Resize/MelchidtheFourFaceBeast.6bpp",
	"graphics/Resize/MelffyRabby.6bpp",
	"graphics/Resize/MetalArmoredBug.6bpp",
	"graphics/Resize/MetaphysArmedDragon.6bpp",
	"graphics/Resize/MightyGuard.6bpp",
	"graphics/Resize/MistValleyWatcher.6bpp",
	"graphics/Resize/MoltenBehemoth.6bpp",
	"graphics/Resize/MonLarvas.6bpp",
	"graphics/Resize/MysteryShellDragon.6bpp",
	"graphics/Resize/MysticClown.6bpp",
	"graphics/Resize/NeoAquaMadoor.6bpp",
	"graphics/Resize/NeoBug.6bpp",
	"graphics/Resize/NightLizard.6bpp",
	"graphics/Resize/NinKenDog.6bpp",
	"graphics/Resize/NobleKnightArtorigus.6bpp",
	"graphics/Resize/OniTankT34.6bpp",
	"graphics/Resize/OppressedPeople.6bpp",
	"graphics/Resize/Opticlops.6bpp",
	"graphics/Resize/Overdrive.6bpp",
	"graphics/Resize/PSYFrameDriver.6bpp",
	"graphics/Resize/PhantasmSpiralDragon.6bpp",
	"graphics/Resize/PhantomGryphon.6bpp",
	"graphics/Resize/PowerProKnightSisters.6bpp",
	"graphics/Resize/PowerProLadySisters.6bpp",
	"graphics/Resize/QueensKnight.6bpp",
	"graphics/Resize/Rabidragon.6bpp",
	"graphics/Resize/RengeGatekeeperofDarkWorld.6bpp",
	"graphics/Resize/RoboticKnight.6bpp",
	"graphics/Resize/RockOgreGrotto2.6bpp",
	"graphics/Resize/Sabersaurus.6bpp",
	"graphics/Resize/SeaSerpentWarriorofDarkness.6bpp",
	"graphics/Resize/ShiningAbyss.6bpp",
	"graphics/Resize/ShiningFriendship.6bpp",
	"graphics/Resize/ShinyBlackCSquadder.6bpp",
	"graphics/Resize/SkullDogMarron.6bpp",
	"graphics/Resize/SkullMariner.6bpp",
	"graphics/Resize/SonicDuck.6bpp",
	"graphics/Resize/SorcereroftheDoomed.6bpp",
	"graphics/Resize/SoulTiger.6bpp",
	"graphics/Resize/Souleater.6bpp",
	"graphics/Resize/SpaceMambo.6bpp",
	"graphics/Resize/SpherousLady.6bpp",
	"graphics/Resize/SpikedSnail.6bpp",
	"graphics/Resize/SpiralSerpent.6bpp",
	"graphics/Resize/SteamKnightHamburk.6bpp",
	"graphics/Resize/StoneDragon.6bpp",
	"graphics/Resize/StoneGhost.6bpp",
	"graphics/Resize/SuppressionCollider.6bpp",
	"graphics/Resize/SwordsmanofLandstar.6bpp",
	"graphics/Resize/TerrorkingSalmon.6bpp",
	"graphics/Resize/ThatWhichFeedsonLife.6bpp",
	"graphics/Resize/TheAllSeeingWhiteTiger.6bpp",
	"graphics/Resize/TheDragonDwellingintheCave.6bpp",
	"graphics/Resize/TheEarlofDemise.6bpp",
	"graphics/Resize/TheGrossGhostofFledDreams.6bpp",
	"graphics/Resize/TheIllusoryGentleman.6bpp",
	"graphics/Resize/TheJudgementHand.6bpp",
	"graphics/Resize/ThePortraitsSecret.6bpp",
	"graphics/Resize/TheStatueofEasterIsland.6bpp",
	"graphics/Resize/TrancetheMagicSwordsman.6bpp",
	"graphics/Resize/VTigerJet.6bpp",
	"graphics/Resize/VenomCobra.6bpp",
	"graphics/Resize/WarriorDaiGrepher.6bpp",
	"graphics/Resize/WarriorofZera.6bpp",
	"graphics/Resize/Wattaildragon.6bpp",
	"graphics/Resize/Wilmee.6bpp",
	"graphics/Resize/WingedDragonGuardianoftheFortress2.6bpp",
	"graphics/Resize/Wingweaver.6bpp",
	"graphics/Resize/Wolf.6bpp",
	"graphics/Resize/WolfAxwielder.6bpp",
	"graphics/Resize/WoodClown.6bpp",
	"graphics/Resize/WoodborgInpachi.6bpp",
	"graphics/Resize/WormDrake.6bpp",
	"graphics/Resize/XHeadCannon.6bpp",
	"graphics/Resize/XSaberAnuPiranha.6bpp",
	"graphics/Resize/Yormungarde.6bpp",
	"graphics/Resize/Zombino.6bpp",
	"graphics/Resize/ZureKnightofDarkWorld.6bpp"
);
...
const u8 gCardPalettes[] = INCBIN_U8(
	...
	"graphics/Resize/30000YearWhiteTurtle.gbapal",
	"graphics/Resize/AbsoluteKingMegaplunder.gbapal",
	"graphics/Resize/AcrobatMonkey.gbapal",
	"graphics/Resize/AlexandriteDragon.gbapal",
	"graphics/Resize/AlienShocktrooper.gbapal",
	"graphics/Resize/AllyofJusticeClausolas.gbapal",
	"graphics/Resize/AmphibianBeast.gbapal",
	"graphics/Resize/AncientSorcerer.gbapal",
	"graphics/Resize/AncientTreeofEnlightenment.gbapal",
	"graphics/Resize/AnotherverseDragon.gbapal",
	"graphics/Resize/AnotherverseGluttonia.gbapal",
	"graphics/Resize/AnotherverseSolaria.gbapal",
	"graphics/Resize/ArchfiendSoldier.gbapal",
	"graphics/Resize/AtlanteanPikeman.gbapal",
	"graphics/Resize/BaronoftheFiendSword.gbapal",
	"graphics/Resize/BattleFootballer.gbapal",
	"graphics/Resize/BeastofTalwar.gbapal",
	"graphics/Resize/BeckonedbytheWorldChalice.gbapal",
	"graphics/Resize/BigKoala.gbapal",
	"graphics/Resize/Bitron.gbapal",
	"graphics/Resize/BladeSkater.gbapal",
	"graphics/Resize/BlazingInpachi.gbapal",
	"graphics/Resize/Blocker.gbapal",
	"graphics/Resize/BoulderTortoise.gbapal",
	"graphics/Resize/BraveScizzar.gbapal",
	"graphics/Resize/Bunilla.gbapal",
	"graphics/Resize/ChamberlainoftheSixSamurai.gbapal",
	"graphics/Resize/CharcoalInpachi.gbapal",
	"graphics/Resize/ChosenbytheWorldChalice.gbapal",
	"graphics/Resize/ChuSketheMouseFighter.gbapal",
	"graphics/Resize/ClavkiystheMagikeySkyblaster.gbapal",
	"graphics/Resize/CrownedbytheWorldChalice.gbapal",
	"graphics/Resize/CyberSoldierofDarkworld.gbapal",
	"graphics/Resize/DDTrainer.gbapal",
	"graphics/Resize/DarkBlade.gbapal",
	"graphics/Resize/DarkTitanofTerror.gbapal",
	"graphics/Resize/Digitron.gbapal",
	"graphics/Resize/DivineDragonRagnarok.gbapal",
	"graphics/Resize/EarthboundSpirit.gbapal",
	"graphics/Resize/ElementalHEROBurstinatrix.gbapal",
	"graphics/Resize/ElementalHEROClayman.gbapal",
	"graphics/Resize/ElementalHERONeos.gbapal",
	"graphics/Resize/ElementalHEROSparkman.gbapal",
	"graphics/Resize/EmpressMantis.gbapal",
	"graphics/Resize/EvilswarmHeliotrope.gbapal",
	"graphics/Resize/FairyoftheFountain.gbapal",
	"graphics/Resize/FairysGift.gbapal",
	"graphics/Resize/FlyingPenguin.gbapal",
	"graphics/Resize/Frostosaurus.gbapal",
	"graphics/Resize/GadgetSoldier.gbapal",
	"graphics/Resize/Gagagigo.gbapal",
	"graphics/Resize/GemKnightCrystal.gbapal",
	"graphics/Resize/GemKnightGarnet.gbapal",
	"graphics/Resize/GemKnightLapis.gbapal",
	"graphics/Resize/GemKnightSapphire.gbapal",
	"graphics/Resize/GemKnightTourmaline.gbapal",
	"graphics/Resize/GeneWarpedWarwolf.gbapal",
	"graphics/Resize/GigaGagagigo.gbapal",
	"graphics/Resize/GilGarth.gbapal",
	"graphics/Resize/GirochinKuwagata.gbapal",
	"graphics/Resize/GladiatorBeastAndal.gbapal",
	"graphics/Resize/GogigaGagagigo.gbapal",
	"graphics/Resize/Golgoil.gbapal",
	"graphics/Resize/GorgonEgg.gbapal",
	"graphics/Resize/Gradius.gbapal",
	"graphics/Resize/GrandTikiElder.gbapal",
	"graphics/Resize/GreatAngus.gbapal",
	"graphics/Resize/GunkanSushipShari.gbapal",
	"graphics/Resize/HeadlessKnight.gbapal",
	"graphics/Resize/HieraticSealoftheSunDragonOverlord.gbapal",
	"graphics/Resize/HumanoidSlime.gbapal",
	"graphics/Resize/HunterDragon.gbapal",
	"graphics/Resize/IgnihorseDragonith.gbapal",
	"graphics/Resize/Inpachi.gbapal",
	"graphics/Resize/InsectKnight.gbapal",
	"graphics/Resize/IslandTurtle.gbapal",
	"graphics/Resize/JerryBeansMan.gbapal",
	"graphics/Resize/JobChangeMirror.gbapal",
	"graphics/Resize/JongleurGhoulIllusionist.gbapal",
	"graphics/Resize/Kabazauls.gbapal",
	"graphics/Resize/KappaAvenger.gbapal",
	"graphics/Resize/LegendaryDuelingField.gbapal",
	"graphics/Resize/Leotron.gbapal",
	"graphics/Resize/LightBringerLucifer.gbapal",
	"graphics/Resize/Lisark.gbapal",
	"graphics/Resize/LusterDragon.gbapal",
	"graphics/Resize/LusterDragon2.gbapal",
	"graphics/Resize/MadDogofDarkness.gbapal",
	"graphics/Resize/MadLobster.gbapal",
	"graphics/Resize/MasterKyonshee.gbapal",
	"graphics/Resize/MegalosmasherX.gbapal",
	"graphics/Resize/MekkKnightAvram.gbapal",
	"graphics/Resize/MelchidtheFourFaceBeast.gbapal",
	"graphics/Resize/MelffyRabby.gbapal",
	"graphics/Resize/MetalArmoredBug.gbapal",
	"graphics/Resize/MetaphysArmedDragon.gbapal",
	"graphics/Resize/MightyGuard.gbapal",
	"graphics/Resize/MistValleyWatcher.gbapal",
	"graphics/Resize/MoltenBehemoth.gbapal",
	"graphics/Resize/MonLarvas.gbapal",
	"graphics/Resize/MysteryShellDragon.gbapal",
	"graphics/Resize/MysticClown.gbapal",
	"graphics/Resize/NeoAquaMadoor.gbapal",
	"graphics/Resize/NeoBug.gbapal",
	"graphics/Resize/NightLizard.gbapal",
	"graphics/Resize/NinKenDog.gbapal",
	"graphics/Resize/NobleKnightArtorigus.gbapal",
	"graphics/Resize/OniTankT34.gbapal",
	"graphics/Resize/OppressedPeople.gbapal",
	"graphics/Resize/Opticlops.gbapal",
	"graphics/Resize/Overdrive.gbapal",
	"graphics/Resize/PSYFrameDriver.gbapal",
	"graphics/Resize/PhantasmSpiralDragon.gbapal",
	"graphics/Resize/PhantomGryphon.gbapal",
	"graphics/Resize/PowerProKnightSisters.gbapal",
	"graphics/Resize/PowerProLadySisters.gbapal",
	"graphics/Resize/QueensKnight.gbapal",
	"graphics/Resize/Rabidragon.gbapal",
	"graphics/Resize/RengeGatekeeperofDarkWorld.gbapal",
	"graphics/Resize/RoboticKnight.gbapal",
	"graphics/Resize/RockOgreGrotto2.gbapal",
	"graphics/Resize/Sabersaurus.gbapal",
	"graphics/Resize/SeaSerpentWarriorofDarkness.gbapal",
	"graphics/Resize/ShiningAbyss.gbapal",
	"graphics/Resize/ShiningFriendship.gbapal",
	"graphics/Resize/ShinyBlackCSquadder.gbapal",
	"graphics/Resize/SkullDogMarron.gbapal",
	"graphics/Resize/SkullMariner.gbapal",
	"graphics/Resize/SonicDuck.gbapal",
	"graphics/Resize/SorcereroftheDoomed.gbapal",
	"graphics/Resize/SoulTiger.gbapal",
	"graphics/Resize/Souleater.gbapal",
	"graphics/Resize/SpaceMambo.gbapal",
	"graphics/Resize/SpherousLady.gbapal",
	"graphics/Resize/SpikedSnail.gbapal",
	"graphics/Resize/SpiralSerpent.gbapal",
	"graphics/Resize/SteamKnightHamburk.gbapal",
	"graphics/Resize/StoneDragon.gbapal",
	"graphics/Resize/StoneGhost.gbapal",
	"graphics/Resize/SuppressionCollider.gbapal",
	"graphics/Resize/SwordsmanofLandstar.gbapal",
	"graphics/Resize/TerrorkingSalmon.gbapal",
	"graphics/Resize/ThatWhichFeedsonLife.gbapal",
	"graphics/Resize/TheAllSeeingWhiteTiger.gbapal",
	"graphics/Resize/TheDragonDwellingintheCave.gbapal",
	"graphics/Resize/TheEarlofDemise.gbapal",
	"graphics/Resize/TheGrossGhostofFledDreams.gbapal",
	"graphics/Resize/TheIllusoryGentleman.gbapal",
	"graphics/Resize/TheJudgementHand.gbapal",
	"graphics/Resize/ThePortraitsSecret.gbapal",
	"graphics/Resize/TheStatueofEasterIsland.gbapal",
	"graphics/Resize/TrancetheMagicSwordsman.gbapal",
	"graphics/Resize/VTigerJet.gbapal",
	"graphics/Resize/VenomCobra.gbapal",
	"graphics/Resize/WarriorDaiGrepher.gbapal",
	"graphics/Resize/WarriorofZera.gbapal",
	"graphics/Resize/Wattaildragon.gbapal",
	"graphics/Resize/Wilmee.gbapal",
	"graphics/Resize/WingedDragonGuardianoftheFortress2.gbapal",
	"graphics/Resize/Wingweaver.gbapal",
	"graphics/Resize/Wolf.gbapal",
	"graphics/Resize/WolfAxwielder.gbapal",
	"graphics/Resize/WoodClown.gbapal",
	"graphics/Resize/WoodborgInpachi.gbapal",
	"graphics/Resize/WormDrake.gbapal",
	"graphics/Resize/XHeadCannon.gbapal",
	"graphics/Resize/XSaberAnuPiranha.gbapal",
	"graphics/Resize/Yormungarde.gbapal",
	"graphics/Resize/Zombino.gbapal",
	"graphics/Resize/ZureKnightofDarkWorld.gbapal"
);
